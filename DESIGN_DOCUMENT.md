...
- **Frontend:**
  ...
  - **TailwindCSS:** A utility-first CSS framework used with WGA-owned semantic roles and shared presentation primitives.
...
- **Styling:**
  ...
  - WGA-owned semantic roles and shared presentation primitives are defined in `resources/css/style.pcss` and processed by PostCSS.
...
- **Services:** `mise run dev` brings up local Mailpit and Garage services with Podman Compose, then starts the asset and template watchers.
- **Running:**
