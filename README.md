...
| `WGA_SENTRY_DSN`         | Optional Sentry DSN used for server error monitoring                                             |
| `WGA_SENTRY_BROWSER_DSN` | Optional public Sentry DSN used for browser error monitoring                                     |
