...
- [ ] 3.3 Manually verify an artist with a separately staged portrait shows the image and matching page metadata, while an artist without one shows the fallback.
