...
### Requirement: Artwork records offer three explainable related-work bases

The system SHALL let visitors select BY ARTIST, SAME COLLECTION, or SAME PERIOD for related works, and SHALL represent the active basis in the artwork URL. Palette data SHALL remain available as an explanatory artwork visualisation but SHALL NOT be exposed as a related-work basis.
...
The system SHALL provide a counted `FIND MORE … IN THE ARTWORK SEARCH` link for artist, collection, and period bases using the corresponding server-generated artwork-search filter URL.
