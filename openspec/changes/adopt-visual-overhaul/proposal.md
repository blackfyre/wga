...
- Adopt the complete non-development public feature set and Rams-inspired visual system from `wga-visual-overhaul`, with pixel-accurate Chrome reference rendering at 390px, 834px, and 1440px viewports.
...
- Deliver shared public interactions: keyboard navigation and command palette, accessible dialogs and image viewer, glossary help, citation copying, theme and bionic-reading preferences, period music, cookie notice, and responsive behaviour.
