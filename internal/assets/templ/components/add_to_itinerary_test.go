...
func TestAddToItineraryActionVariants(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			wrapper:   "shrink-0",
			button:    base + " text-(length:--t-11) tracking-[1.5px] px-[22px] h-12 border-control hover:border-wga-accent hover:bg-wga-accent-tint hover:text-wga-accent",
...
func TestAddToItineraryButtonLegacyPreservesOriginalRendering(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			name:    "compact available",
			variant: "compact",
			button:  base + " border-control px-3 py-1.5 text-wga-ink/70 hover:border-wga-ink",
			label:   "ADD TO ITINERARY",
		},
		{
			name:    "block available",
			variant: "block",
			button:  base + " border-control px-3 py-1.5 text-wga-ink/70 hover:border-wga-ink block w-full",
			label:   "ADD TO ITINERARY",
		},
		{
			name:         "compact added",
			variant:      "compact",
			added:        true,
			button:       base + " cursor-not-allowed border-wga-ink/20 px-3 py-1.5 text-wga-ink/40",
			label:        "ADDED",
			disabled:     true,
			ariaDisabled: true,
		},
		{
			...
			variant:      "block",
			added:        true,
			button:       base + " cursor-not-allowed border-wga-ink/20 px-3 py-1.5 text-wga-ink/40 block w-full",
			label:        "ADDED",
			disabled:     true,
			ariaDisabled: true,
		},
